...
- **Khi động vào file trong `notebooks/`: đọc thêm `PROJECT_CONTEXT.md` mục 6 (Quy ước định dạng notebook) TRƯỚC KHI sửa** — mục 3/4 không chứa quy ước này.
  - **Không có quy định "notebook phải đủ 6 mục lớn".** Số mục lớn **không cố định, tuỳ nội dung** (NB01 có 6 mục, NB02–NB06 có 7 — đều đúng). Quy định thật là **mục Tổng kết phải đứng CUỐI**, mang số thứ tự kế tiếp của notebook đó. **Đừng nhồi/gộp mục cho khớp một con số nào cả.**
