...
- **Task:** Rà soát + sửa notebook 05 (Feature Engineering) của Thắng và gỡ conflict khi merge nhánh t10
- **Nhánh:** `docs/hung-context-t10-nb05` (cập nhật context); phần sửa code nằm ở `feature/t10-feature-engineering`
- **Trạng thái:** Đã vá + chạy lại NB05 xác nhận hết lỗi, đã commit trên nhánh t10; ghi context ở nhánh này
